...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 15, 2019 lúc 08:59 PM
...
(68, 'medias/5c3e2d821483c.170531_04022012_616687.mp3', '2019-01-15 18:59:14', 'script part 3', '2019-01-15 18:59:14');
...
(15, 59, 1, 'C', 'images/part1/5c3e12d156611.jpeg', 1, NULL, '2019-01-15 17:05:21', '2019-01-15 17:05:21');
...
(19, 'q1', 'a1', 'b1', 'c1', 'd1', 'C', 68, 1, 11, '2019-01-15 18:59:14', '2019-01-15 18:59:14'),
(20, 'q2', 'a2', 'b2', 'c2', 'd2', 'A', 68, 1, 11, '2019-01-15 18:59:14', '2019-01-15 18:59:14');
...
--
-- Cấu trúc bảng cho bảng `test_user`
--
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `status`, `role`, `remember_token`, `serial_id`, `created_at`) VALUES
(4, 'thuy', 'vuthithuy10197@gmail.com', '$2y$10$zyJD6vmFcSMkOSoI0K.V3.FrRR.TyMN/s0Ue2oxqfcRpBJk0sdBpy', 1, '1000', 'Yht1RTJZ5Ph0MiooLflvVfN8lBBaZR8CcpKpySP9f40rgMfvZQBbZmCKyhNW', NULL, '2019-01-11 22:47:40');
...
--
-- AUTO_INCREMENT cho bảng `test_user`
--
ALTER TABLE `test_user`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Các ràng buộc cho bảng `test_user`
--
ALTER TABLE `test_user`
  ADD CONSTRAINT `test_user_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `test_user_ibfk_2` FOREIGN KEY (`test_id`) REFERENCES `test` (`id`);
