...
@endif
          <!-- form start -->
            <div class="box-header">
                <h3 class="box-title">Add Question Part 2: Qu-Response
                </h3>
                <!-- tools box -->
        ...
        <table class="table table-bordered table-hover scroll" id="table_test1" >
            ...
            <tr>
                ...
                <td>{{ $part2->level['level'] }}</td>
                    ...
                    <td class="text-center">
                        <button type="button" class="btn btn-sm btn-danger btn-remove"  data-id="{{ $part2->id }}" linkUrl="{{ route('part2.delete', ['id' => $part2->id])}}" data-table = "#table_test1">
